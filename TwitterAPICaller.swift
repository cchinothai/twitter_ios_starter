...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "n8jjRIyfzEDeqDlQHZNz3QzuX", consumerSecret: "sEpMCmnR4lVrNtTOp7hnOujIyr3OGZoPOLwmglrz2Np47imXDc")
    var loginSuccess: (() -> ())?
